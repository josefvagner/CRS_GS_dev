...
GFX::GFX(uint8_t const width, uint8_t const height, spi_inst_t *spi, uint8_t resetPin, uint8_t csPin, uint8_t dcPin) : SSD1309(width, height, spi, resetPin, csPin, dcPin){};
