...
typedef enum
{
    CAN_MESSAGE_NEOPIXEL,
    CAN_MESSAGE_BUTTON_LED,
    CAN_MESSAGE_BUTTON,
    /* number of messages */
    CAN_MESSAGE_COUNT,
} can_message_type;
...
static const uint8_t message_size[] = {
    sizeof(struct can_message_neopixel_s),
    sizeof(struct can_message_button_led_s),
    sizeof(struct can_message_button_s),
};
...
typedef struct
{
    ...
    union
    {
        struct can_message_neopixel_s neopixel;
        struct can_message_button_led_s button_led;
        struct can_message_button_s button;
